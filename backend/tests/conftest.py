...
from app.models import Album, Library, Photo, PhotoMetadata, PlaceSummary, Task, User, Version, album_photos
...
def db_session(engine):
    ...
    with engine.begin() as connection:
        ...
        for table in [PhotoMetadata, Version, Photo, Album, Library, User, Task, PlaceSummary]:
