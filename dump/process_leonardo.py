...
from lib.leonardo import Leonardo
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        input_folder = "./output/leonardo"

    print(f"Processing Mage images from: {input_folder}")
    ...
    for root, dirs, files in os.walk(input_path):
        for file in files:
            if is_image(file):
                ...
                image, generation = leonardo.extract_image_metadata(file_path)
